...
/**
 * Class BasicTierSMTest
 * @package Tests\Unit\Core\Customer\Accounts
 */
class BasicTierSMTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $machine = new BasicTierSM($account);
    ...
    public function getFailureCases()
    {
        ...
        $lowerAccount->method('getBalance')->willReturn(40);
